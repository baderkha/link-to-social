        ...
        <Router>
          <div >
            ...
            <div style={{ marginTop: "10px", minHeight: "92.3vh" }}>
              <Routes>
                <Route path="/profile" element={<NavView childComponents={<Profile />} />} />
                <Route path="/build-page" element={<NavView childComponents={<Builder accountId="ahmad" />} />} />
